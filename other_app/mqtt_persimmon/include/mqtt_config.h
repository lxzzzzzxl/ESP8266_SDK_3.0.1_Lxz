...
#define MQTT_HOST            "120.76.100.197" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            18831    // the listening port of your MQTT server or MQTT broker
...
#define MQTT_USER            "111" // your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS            "111" // you MQTT login password, same as above
#define STA_SSID "realthread_VIP"    // your AP/router SSID to config your device networking
#define STA_PASS "1234567o" // your AP/router password
